    ...
    <div class="container mx-auto pt-8">
      <div class="lg:flex">
        <div id="left" class="lg:w-2/3">
          <div class="card">
            @if ($community->type == 3 && (!Auth::check() || (Auth::check() && !Auth::user()->isMember($community))))
              <p>Cette publication appartient à une communauté privée. Seuls les membres peuvent la voir.</p>
            @else
              ...
              @auth
                ...
                @if ($community->type == 2 && !Auth::user()->isMember($community))
                  <p>Seuls les membres de cette communauté peuvent commenter les publications.</p>                  
                @else
                    ...
                    <div class="flex wrapper" data-hash="{{ $comment->hash }}" data-type="root" data-name="{{ $comment->user->display_name }}">
                      ...
                      <div class="ml-4">
                        ...
                        <div class="flex items-center">
                          ...
                          @if (Auth::check() && Auth::user()->isMember($community))
